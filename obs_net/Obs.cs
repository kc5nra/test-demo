...
namespace libobs {
    ...
    public partial class Obs {
        ...
        [DllImport(importLibrary, CallingConvention = importCall)]
        public static extern obs_display_t obs_display_create(gs_init_data graphics_data, uint background_color);

        public delegate void DrawCallback(IntPtr param, uint cx, uint cy);
        
        [DllImport(importLibrary, CallingConvention = importCall)]
        public static extern void obs_display_add_draw_callback(obs_display_t display,
                   [MarshalAs(UnmanagedType.FunctionPtr)] DrawCallback func,
                   IntPtr param);
        ...
        [DllImport(importLibrary, CallingConvention = importCall)]
        public static extern void obs_display_resize(obs_display_t display, uint cx, uint cy);
    }
